    ...
    if (type === 'email') {
      ...
      const msg = {
        ...
        html: registerMessage(
          "Hive Afrika",
          user.firstname,
          "To reset your password, use the code below to as the reset token. Please ignore this email if you did not register with Hive Afrika",
          activationToken
        ),
      };
    ...
    if (type === 'sms') {
      ...
      const msg = {
        ...
        html: genericMessage(
          "Hive Afrika",
          user.firstname,
          "Your password reset was successful. If you did not initiate this, contact support@hiveafrika.com",
        ),
      };
      await sgMail.send(msg);
    }

...
import Slide from '../../assets/images/colors.jpg'
...
const VerifyEmail = () => {
    ...
    const resendToken = async () => {
        try {
            ...
            setLoad(true)
            const { data: res } = await base.get('/hive/user/resend/email-verification')
    ...
    const onFormSubmit = async () => {
        ...
        try {
            setLoad(true)
            const { data: res } = await base.post('/hive/user/verify-account', { code })
